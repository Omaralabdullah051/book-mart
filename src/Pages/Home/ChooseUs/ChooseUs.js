    ...
    <div className="text-green-600 font-bold mt-24">
      ...
      <div className="md:grid md:grid-cols-2 xl:grid-cols-3 gap-6 mt-6 xl:mt-12 p-4 md:p-8 px-5 md:px-16">
        {advantages.map((advantage) => (
          <div
            className="md:hover:bg-green-600 md:first:bg-green-600 md:first:text-black bg-gray-800 py-8 px-4 md:p-8 space-y-2 md:hover:text-black cursor-pointer mb-3 odd:bg-green-600 odd:text-black even:text-gray-500"
            key={advantage._id}
          >
