    ...
    return (
        <div className='text-green-600 font-bold mb-52'>
            ...
            <div className='w-[320px] md:w-[500px] mx-auto'>
                <form onSubmit={handleOnSubmit} className='flex flex-col md:border-2 border-gray-700 mx-auto mt-3 md:mt-24 rounded-lg'>
                    ...
                    <input ref={emailRef} className='w-[300px] md:w-[400px] mx-auto mb-3 bg-gray-700 text-green-400 font-bold rounded mt-10 md:mt-12 required:border-red-500' type="email" name="userEmail" id="userEmail" placeholder='Your Email' autoComplete='off' required />
                    <input ref={passwordRef} className='w-[300px] md:w-[400px] mx-auto mb-3 bg-gray-700 text-green-400 font-bold rounded required:border-red-500' type="password" name="password" id="password" placeholder='Your password' autoComplete='off' required />
                    ...
                    <input className='w-[300px] md:w-[400px] mx-auto mb-3 px-8 py-2 bg-green-600 text-gray-300 rounded font-bold hover:bg-green-400 hover:text-black mt-3 focus:ring-4 focus:ring-offset-slate-800' type="submit" value="Login" />
                    <SocialLogin />
                </form>
            </div>
        </div>
