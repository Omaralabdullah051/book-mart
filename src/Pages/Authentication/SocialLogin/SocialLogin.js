...
const SocialLogin = () => {
  ...
  const [signInWithGithub, githubUser, loading3, githubError] =
    ...
    if (hookError) {
      switch (hookError?.code) {
        case "auth/account-exists-with-different-credential":
          toast.error(
            "Doesn't allow to log in with same email that exists with different credential"
          );
          break;
    ...
    <div className="mb-2 md:mb-8">
      ...
      <div className="md:flex justify-center items-center">
        <div
          ...
          className="flex justify-center items-center bg-green-600 text-black mb-3 mr-3 md:mr-2 p-1 rounded cursor-pointer hover:bg-green-900 hover:text-gray-400 focus:ring-4 focus:ring-offset-slate-800 ml-3 md:ml-0"
        >
          <img
            className="w-12"
        ...
        <div
          ...
          className="flex justify-center items-center bg-green-600 text-black mb-3 p-1 rounded cursor-pointer hover:bg-green-900 hover:text-gray-400 focus:ring-4 focus:ring-offset-slate-800 ml-3 mr-3 md:ml-0 md:mr-0"
        >
          <img
            className="w-10 mr-1"
