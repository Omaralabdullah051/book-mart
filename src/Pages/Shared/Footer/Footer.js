        ...
        <footer className="bg-gray-800 mt-80">
            <div className='md:flex justify-around items-center text-center md:text-justify'>
                ...
                <div className='text-green-600 space-y-3 font-bold mt-8 md:mt-20'>
                    <h6>Contact Info</h6>
                    <p className='text-sm md:text-base'><FontAwesomeIcon className='mr-3' icon={faPhone} />+1 (396)-292-2391</p>
                    <p className='text-sm md:text-base'><FontAwesomeIcon className='mr-3' icon={faEnvelope} />Omaralabdullah051@gmail.com</p>
                    <p className='text-sm  md:text-base'><FontAwesomeIcon className='mr-3' icon={faLocationDot} />455 7th Ave, NY 99937, BD</p>
                    <div className='md:flex justify-center items-center px-4 md:px-0'>
                        ...
                        <a href='https://github.com/Omaralabdullah051' target="blank" className='flex justify-center items-center bg-green-600 text-black mb-3 p-1 px-3 rounded cursor-pointer hover:bg-green-900 hover:text-gray-400 focus:ring-4 focus:ring-offset-slate-800 mr-2 md:mr-0'>
            ...
            <p className='text-green-600 font-bold text-center pt-2 pb-8'><small><FontAwesomeIcon className='mr-1' icon={faCopyright} />{year}. All Right Reserved</small></p>
        </footer>
    );
};
